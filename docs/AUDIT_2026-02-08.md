...
- `facebook_ads_insights_dedup` (126,089 clean rows)
...
**Rule: Always use `_dedup` views for Facebook analysis. Never query raw `facebook_ads_insights` directly.**
...
|--------------|--------|-------------|-------|
| **ROAS by Campaign** | YES | shopify_utm + facebook_ads_insights_dedup | 22/38 UTM campaigns match Facebook campaign names |
...
| **Geo Performance** | YES | facebook_ads_insights_region_dedup + GA4 | Cross-platform geo matching |
| **Creative Performance** | YES | facebook_ads_insights_dedup + facebook_ad_creatives | Join on ad_id |
| **Audience Insights** | YES | facebook_ads_insights_age_and_gender_dedup | Age/gender breakdown |
| **TikTok Campaign ROAS** | YES | shopify_utm + tiktokads_reports_daily | 34/34 UTM campaigns match TikTok |
